<template>
  <div :style="{ backgroundImage: `url('${bgImageUrl}')` }" class="full-screen-div" @click="handleClick">
    <!-- 显示点击坐标 -->
    ...
    <!-- 显示所有坐标表单 -->
    <div v-for="item in zuobiaoList" :key="item.id" @click.stop="handleFormClick(item)" :style="{
      position: 'absolute',
